...
stringData:
  type: git
  url: https://github.com/federated-fleet-forge/example-ocp-gitops-base
...
- `https://github.com/federated-fleet-forge/example-ocp-policies`
- `https://github.com/federated-fleet-forge/example-ocp-ztp`
